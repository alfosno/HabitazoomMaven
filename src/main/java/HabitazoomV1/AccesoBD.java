...
public class AccesoBD {
	...
	public void anadirUsuario (Usuario usuario) throws Excepcion {
		String insertBody = "INSERT INTO Usuario (Correo,Nombre,Apellidos,Alias,Contrase�a,Fecha_Nacimiento,Descripcion)"
				+ " values (?,?,?,?,?,?,?)";
		try {
			...
			throw new Excepcion("no se ha podido a�adir al usuario");
		}
	}
	
	public void updateUsuario (Usuario usuario) {
		try {
			String updateBody = "UPDATE Usuario SET Nombre = ?, Apellidos = ?, Alias = ?, Contrase�a = ?, "
	...
	public void anadirHabitacion (Habitacion hab) {
        String insertBody = "INSERT INTO Habitacion (idHabitacion,Direccion,Numero,Planta,Puerta,Descripcion,Tama�o,Parking,Terraza,Wifi,Fumadores,Mascotas,Solo_Estudiantes,Gastos_Incluidos,Propietario,DistritoNombre,DistritoCP)"
                + " values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
            PreparedStatement preparedStatement = conn.prepareStatement(insertBody,
                    PreparedStatement.RETURN_GENERATED_KEYS);
